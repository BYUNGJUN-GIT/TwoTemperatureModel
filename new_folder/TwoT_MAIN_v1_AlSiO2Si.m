...
sens_th = 0; % sensitivity to thermal parameters
sens_z = 0;  % sensitivity to thickness/absorption/pulse
...
if sens_th
    [Sens,Sensnorm] = TwoT_CeLeTdep_Pulse_SENS_v1(dx,nx,LambdaL,LambdaE,CL,gammaE,T0,Gll,gEL,tdelay_model,delta_time,nt,heatL,heatE,PulseTemp,IndFit);
end

if sens_z
    [Sens_z,Sensnorm_z] = TwoT_CeLeTdep_Pulse_SENS_z_v1(dx,nx,LambdaL,LambdaE,CL,gammaE,T0,Gll,gEL,tdelay_model,delta_time,nt,para);
end
